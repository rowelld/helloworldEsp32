#ifndef COMPONENTS_WIFI_NAT_PAGES
#define COMPONENTS_WIFI_NAT_PAGES
...
<body>\
<div id='config'>\
<h1>Xeleqt AIM1 NAT Router Config</h1>\
<script>\
if (window.location.search.substr(1) != '')\
{\
document.getElementById('config').display = 'none';\
document.body.innerHTML ='<h1>Xeleqt AIM1 NAT Router Config</h1>The new settings have been sent to the device.<br/>The page will refresh soon automatically...';\
...
<small>\
<i>Leave it in blank if you want your device to get an IP using DHCP</i>\
</small>\
</form>\
\
...
#endif /* COMPONENTS_WIFI_NAT_PAGES */
